...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 22, sizeof(::Trd_PlaceOrder::C2S)},
  { 39, 47, sizeof(::Trd_PlaceOrder::S2C)},
  { 50, 56, sizeof(::Trd_PlaceOrder::Request)},
  { 57, 66, sizeof(::Trd_PlaceOrder::Response)},
};
...
C2S::C2S(const C2S& from)
  ...
  ::memcpy(&trdside_, &from.trdside_,
    ...
    reinterpret_cast<char*>(&trdside_)) + sizeof(trailspread_));
...
// @@protoc_insertion_point(class_specific_merge_from_start:Trd_PlaceOrder.C2S)
  ...
  if (cached_has_bits & 0x00010000u) {
    set_trailspread(from.trailspread());
  }
}
