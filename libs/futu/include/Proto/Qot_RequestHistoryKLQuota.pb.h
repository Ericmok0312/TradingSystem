...
// optional string name = 4;
inline bool DetailItem::has_name() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void DetailItem::set_has_name() {
  _has_bits_[0] |= 0x00000002u;
}
inline void DetailItem::clear_has_name() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void DetailItem::clear_name() {
  name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_name();
}
inline const ::std::string& DetailItem::name() const {
  // @@protoc_insertion_point(field_get:Qot_RequestHistoryKLQuota.DetailItem.name)
  return name_.GetNoArena();
}
inline void DetailItem::set_name(const ::std::string& value) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:Qot_RequestHistoryKLQuota.DetailItem.name)
}
#if LANG_CXX11
inline void DetailItem::set_name(::std::string&& value) {
  set_has_name();
  name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:Qot_RequestHistoryKLQuota.DetailItem.name)
}
#endif
inline void DetailItem::set_name(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Qot_RequestHistoryKLQuota.DetailItem.name)
}
inline void DetailItem::set_name(const char* value, size_t size) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Qot_RequestHistoryKLQuota.DetailItem.name)
}
inline ::std::string* DetailItem::mutable_name() {
  set_has_name();
  // @@protoc_insertion_point(field_mutable:Qot_RequestHistoryKLQuota.DetailItem.name)
  return name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* DetailItem::release_name() {
  // @@protoc_insertion_point(field_release:Qot_RequestHistoryKLQuota.DetailItem.name)
  clear_has_name();
  return name_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void DetailItem::set_allocated_name(::std::string* name) {
  if (name != NULL) {
    set_has_name();
  } else {
    clear_has_name();
  ...
  // @@protoc_insertion_point(field_set_allocated:Qot_RequestHistoryKLQuota.DetailItem.name)
}
