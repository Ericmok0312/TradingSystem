...
inline const ::std::string& S2C::name() const {
  // @@protoc_insertion_point(field_get:Qot_UpdateTicker.S2C.name)
  return name_.GetNoArena();
}
inline void S2C::set_name(const ::std::string& value) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:Qot_UpdateTicker.S2C.name)
}
#if LANG_CXX11
inline void S2C::set_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:Qot_UpdateTicker.S2C.name)
}
#endif
inline void S2C::set_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:Qot_UpdateTicker.S2C.name)
}
inline void S2C::set_name(const char* value, size_t size) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Qot_UpdateTicker.S2C.name)
}
inline ::std::string* S2C::mutable_name() {
  set_has_name();
  // @@protoc_insertion_point(field_mutable:Qot_UpdateTicker.S2C.name)
  return name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* S2C::release_name() {
  // @@protoc_insertion_point(field_release:Qot_UpdateTicker.S2C.name)
  clear_has_name();
...
inline void S2C::set_allocated_name(::std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Qot_UpdateTicker.S2C.name)
}
